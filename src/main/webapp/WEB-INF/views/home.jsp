...
<head>
    ...
    <link href="<c:url value='/jtable.2.4.0/themes/jqueryui/jtable_jqueryui.css'/>" type="text/css" rel="stylesheet">
    <link href="<c:url value='/css/main.css'/>" type="text/css" rel="stylesheet">
</head>
<body>


<h2 class="page-ttl">Welcome to MyCRM</h2>

<div id="MyTableContainer" class="table-cont"></div>
